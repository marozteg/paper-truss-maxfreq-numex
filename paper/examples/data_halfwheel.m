function [coord, elem, dof, adof, E, rho, f] = data_halfwheel(nat_numb) 
    pp = 2*nat_numb; % even number
    nx = 2*pp + 1;
    ny = pp + 1;
    nz = 1;
    index = 1;
    ...
    f = zeros(ndof,1);
    bottoncenternode = pp+1;
    f((bottoncenternode-1)*3+2,1) = -1;%1e3; % N
    f = f(adof,:);
end