function [coord, elem, dof, adof, E, rho, f] = data_example49()
    % example 4.9 2008-SJO-Achtziger-Kocvara.pdf
    ...
    %draw_elem(coord,elem,ones(size(elem,1),1),1,0);
    elem(elem2rem,:) = [];
    ...
    f = zeros(ndof,1);
    f((33-1)*3+2,1) = -10.0;%-0.461426;%-1.0; % N
    f = f(adof,:);
end